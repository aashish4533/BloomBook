/** Curated BookBloom routes for AI assistant — keep in sync with frontend App.tsx */
...
- /book/{id} — Single book details (use a real listing id from searchInventory when you mention [Product: id])
