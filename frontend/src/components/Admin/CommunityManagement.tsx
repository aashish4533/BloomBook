// Updated src/components/Admin/CommunityManagement.tsx
...
export function CommunityManagement() {
  ...
  const handleFlag = async (id: string) => {
    ...
    const newStatus = community.status === 'flagged' ? 'active' : 'flagged';
    try {
      ...
      toast.success(newStatus === 'flagged' ? 'Community flagged' : 'Community unflagged');
    } catch (err) {
